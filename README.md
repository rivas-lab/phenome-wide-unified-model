...
## Prerequisites: 
- Install Hail==0.2.13 (see instructions for setting up Hail on Sherlock cluster [here](https://github.com/rivas-lab/phenome-wide-unified-model/blob/main/hail-set-up-instructions.md).)
